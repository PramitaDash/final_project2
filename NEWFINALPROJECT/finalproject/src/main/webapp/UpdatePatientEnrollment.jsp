	...
	<div class="">
		<h:form>
			<div class="container">
				...
				<h:commandButton action="#{patientCrontroller.updatePatientValid(editPatient)}" value="All Patient"  />
					&nbsp; 
				...
				<div class="button" style="text-align: center">
					 <%--  <h:commandLink action="#{patientCrontroller.updatePatientValid(editPatient)}" value="All Patient" />
					&nbsp;  --%>
					<h:commandButton
						action="#{patientCrontroller.updatePatientValid(editPatient)}"
						value="updated" style="width: 20%"/>
				</div>
