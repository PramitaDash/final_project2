package com.java.hib;
	...
	public class PatientPaginationBean {

		private static final long serialVersionUID = 1L;
		private List<Patientenrollment> cdList;
		private PatientenrollmentDAOImpl queryHelper;
		/**
		 * pagination stuff
		 */
		 ...
		 */
		public PatientPaginationBean() {
			queryHelper = new PatientenrollmentDAOImpl();
			/**
		...
		public List<Patientenrollment> getPatientList() {
			if (cdList == null) {
				loadEmploy();
			}
			return cdList;
		}
		public void setCdList(List<Patientenrollment> cdList) {
			this.cdList = cdList;
		}
