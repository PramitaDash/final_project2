package com.java.hib;
	...
	public class ProviderPeginationbean {

		private static final long serialVersionUID = 1L;
		private List<ProviderDetails> cdList;
		private ProviderDetailsDAOImpl queryHelper;
		/**
		 * pagination stuff
		 */
		 ...
		 */
		public ProviderPeginationbean() {
			queryHelper = new ProviderDetailsDAOImpl();
			/**
		...
		public List<ProviderDetails> getProviderList() {
			if (cdList == null) {
				loadEmploy();
			}
			return cdList;
		}
		public void setCdList(List<ProviderDetails> cdList) {
			this.cdList = cdList;
		}
		...
		private void loadEmploy() {
			...
			cdList = queryHelper.getListOfProvider(firstRow, rowsPerPage);
